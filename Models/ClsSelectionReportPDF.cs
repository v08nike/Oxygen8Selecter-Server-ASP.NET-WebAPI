...
{
    public class ClsSelectionReportPDF
    {
        public ClsSelectionReportPDF()
        {
        }


        public byte[] /*MemoryStream*/ getBytArrCoverPage(int _intReportStageID, PdfPTable _PdfPTable, ClsID.enmPageOrientation _enmPageOrientation, string _strHeaderImg, string _strFooterImg, int _intProdTypeID, string _strUnitModel, bool _bolIsCoverPage, bool _bolIsCoreAHRICertified)
        {
            ...
            PageEventHandler.ReportStageID = _intReportStageID;
        ...
        public byte[] /*MemoryStream*/ getBytArrDrawingRotated(PdfPTable _PdfPTable, ClsID.enmPageOrientation _enmPageOrientation, string _strHeaderImg, string _strFooterImg)
        {
            MemoryStream msPDFData = new MemoryStream();
            Document document;
            //Rectangle pageSize = document.PageSize;
        ...
        public byte[] /*MemoryStream*/ getBytArrSelection(int _intReportStageID, List<PdfPTable> _lst_PdfPTableSchedule, string _strHeaderImg, string _strFooterImg, string _strUnitModel)
        {
            ...
            SelectionHeaderFooter PageEventHandler = new SelectionHeaderFooter();
            PageEventHandler.ReportStageID = _intReportStageID;
            PageEventHandler.HeaderImageName = _strHeaderImg;
            PageEventHandler.FooterImageName = _strFooterImg;
    ...
    //-----------------------------------------------------------------------------------------------------
    //-----------------------------------------------------------------------------------------------------
    public class SelectionHeaderFooter : PdfPageEventHelper
    {
        ...
        private int _ReportStageID;
        public int ReportStageID
        {
            get { return _ReportStageID; }
            set { _ReportStageID = value; }
        }
        ...
        public override void OnStartPage(PdfWriter writer, Document document)
        {
            ...
            if (HeaderImageName != string.Empty)
            {
                ...
                //img.SetAbsolutePosition(pageSize.GetLeft(0), pageSize.GetTop(50));
            ...
            if (HeaderRight != string.Empty)
            {
                ...
                HeaderTable.TotalWidth = 215;
                HeaderTable.SetWidthPercentage(new float[] { 10, 25 }, pageSize);

                HeaderTable.AddCell(get_cellHeaderFooter(HeaderRight, 1, 16d, 1));
                //HeaderTable.AddCell(get_cellHeaderFooter("SELECTION", 16d, 0));


                if (ReportStageID == ClsID.intReportStageSelecionID)
                {
                    HeaderTable.AddCell(get_cellHeaderFooter("SELECTION ONLY", 1, 16d, 0));
                    HeaderTable.AddCell(get_cellHeaderFooter("", 1, 16d, 0));
                    HeaderTable.AddCell(get_cellHeaderFooter("Not for Submittal Use", 1, 13d, 0));
                    HeaderTable.WriteSelectedRows(0, -1, pageSize.GetRight(213), pageSize.GetTop(32), cb);
                }
                else if (ReportStageID == ClsID.intReportStageSubmittalID)
                {
                    HeaderTable.AddCell(get_cellHeaderFooter("SUBMITTALS", 1, 16d, 0));
                    HeaderTable.WriteSelectedRows(0, -1, pageSize.GetRight(175), pageSize.GetTop(32), cb);
                }
        ...
        public override void OnEndPage(PdfWriter writer, Document document)
        {
            ...
            //img = iTextSharp.text.Image.GetInstance(System.Web.HttpContext.Current.Server.MapPath("Images/img_unit_new.png"));
            ...
            if (bolIsCoverPage)
            {
                switch (intProdTypeID)
                {
                    case ClsID.intProdTypeNovaID:
                        ...
                        //img = iTextSharp.text.Image.GetInstance(System.Web.HttpContext.Current.Server.MapPath("Images/img_nova_2.png"));
                        imgCell1 = new iTextSharp.text.pdf.PdfPCell();
                        img.ScaleAbsolute(550f, 230f);
                        imgCell1.Border = 0;
                        imgCell1.AddElement(new Chunk(img, 0, 0));
                    ...
                    case ClsID.intProdTypeVentumLiteID:
                        img = iTextSharp.text.Image.GetInstance(System.Web.HttpContext.Current.Server.MapPath("Images/img_ventumlite_cover_page.png"));
                        imgCell1 = new iTextSharp.text.pdf.PdfPCell();
                        img.ScaleAbsolute(395f, 230f);
                        imgCell1.Border = 0;
                        imgCell1.AddElement(new Chunk(img, 0, 0));
            ...
            //if (FooterImageName != string.Empty)
            //{
            //    img = iTextSharp.text.Image.GetInstance(System.Web.HttpContext.Current.Server.MapPath(FooterImageName));
            //    img.ScaleAbsolute(pageSize.Width, 35f);
            //    //img.Alignment = Element.ALIGN_MIDDLE;
            //    imgCell1.Border = 0;
            //    imgCell1.AddElement(new Chunk(img, 0, 0));
            //    img.SetAbsolutePosition(pageSize.GetLeft(0), pageSize.GetBottom(15));
            //    cb.AddImage(img);
            //}
            ...
            if (FooterLeft != string.Empty)
            {
                ...
                //cell1 = phrase;
                FooterTable.AddCell(get_cellHeaderFooter(FooterLeft, 1, 8d, 0));
                cb.SetRGBColorFill(0, 0, 0);
            ...
            if (FooterRight != string.Empty)
            {
                ...
                //phrase = new Phrase(HeaderRight, font1);
                //cell1 = phrase;
                FooterTable.AddCell(get_cellHeaderFooter(FooterRight, 1, 12d, 0));
                cb.SetRGBColorFill(0, 0, 0);
        ...
        private PdfPCell get_cellHeaderFooter(string _strCellContent, int _intColSpan, double dblFontSize, int _intBold)
        {
